    ...
    <section class="section-body">
        ...
        <table style="margin-left: 70px;">
            ...
            <tr>
                ...
                <td style="vertical-align: top;"><?= $data['ket_lahir']['alamat'].' RT. '.sprintf("%03s", $data['ket_lahir']['no_rt']).' RW. '.sprintf("%03s", $data['ket_lahir']['no_rw']).' Kel. '.$data['ket_lahir']['kelurahan'].', Kec. '.$data['ket_lahir']['kecamatan'].', Kota '.$data['ket_lahir']['kota']; ?></td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td>:</td>
