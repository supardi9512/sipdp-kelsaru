...
<div class="content">
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= BASEURL; ?>/ketpindah/store" method="post">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="noPindah" class="form-control-label">No. Pindah</label>
                                    <input type="text" id="noPindah" name="no_pindah" class="form-control form-control-sm" value="<?= $data['no_pindah_max']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tglPindah" name="tgl_pindah" placeholder="Masukkan Tanggal Pindah Penduduk" class="form-control form-control-sm" value="<?php Flasher::oldData('tgl_pindah'); ?>" autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="alasanPindah" class="form-control-label">Alasan Pindah</label>
                                    <?php Flasher::error('alasan_pindah'); ?>
                                    <input type="text" id="alasanPindah" name="alasan_pindah" placeholder="Masukkan Alasan Pindah Penduduk" class="form-control form-control-sm" value="<?php Flasher::oldData('alasan_pindah'); ?>" autocomplete="off">
                                </div>
                            </div>
                        </div>
