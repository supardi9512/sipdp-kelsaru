...
<div class="content">
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= BASEURL; ?>/kartukeluarga/update" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="noKk" class="form-control-label">No. KK</label>
                                    <?php Flasher::error('no_kk'); ?>
                                    <input type="number" id="noKk" name="no_kk" min="1" max="9999999999999999" placeholder="Masukkan No. KK" class="form-control form-control-sm" value="<?= $data['kartu_keluarga']['no_kk']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nik" class="form-control-label">Kepala Keluarga</label>
                                    <input type="hidden" name="nik_old" value="<?= $data['kartu_keluarga']['nik']; ?>">
                                    ...
                                    <select data-placeholder="Pilih Kepala Keluarga" id="nik" name="nik" class="standardSelect" tabindex="1">
                                        ...
                                        <?php foreach($data['penduduk_by_id_rt'] as $penduduk) : ?>
                                            <option value="<?= $penduduk['nik']; ?>" <?= ($data['kartu_keluarga']['nik'] == $penduduk['nik'] ? 'selected' : ''); ?>><?= $penduduk['nik'].' - '.$penduduk['nama_penduduk']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" id="alamat" rows="5" placeholder="Masukkan Alamat Penduduk" class="form-control form-control-sm"><?= $data['kartu_keluarga']['alamat']; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
